 ...
 */
interface NestedScrollEventInit extends CustomEventInit<NestedScrollEventDetail> {
    bubbles?: boolean;
    cancelable?: boolean;
    composed?: boolean;
 ...
 */
export declare class NestedScrollEvent extends CustomEvent<NestedScrollEventDetail> {
